  ...
  <div class="w300 bar_right">
    <div class="w300 zero_margL">
      <div class="booking_form_small">
        ...
        <form action="reservation.php" method="get" id="availability_check" onsubmit="validateFormOnSubmit(this)">
          <fieldset>
            ...
            <select id="room_type" class="small_form_select" onchange="sizeOptChange(this)">
